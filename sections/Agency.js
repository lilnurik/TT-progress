      ...
      <section className='agency bg-top'>
        <div className='container'>
          <div className='heading-title'>
            ...
            <br />
            <Title title='T&T Progress - We make the education affordable' className='title-bg' />
          </div>

          <div className='content flex1'>
            <div className='left w-60 py'>
              <TitleSm title='Our students have been accepted top US universities winning over $100,000 in scholarships' />
